...
PALWORLD_TYPE_HINTS: dict[str, str] = {
    ...
    ".worldSaveData.InLockerCharacterInstanceIDArray.Value": "StructProperty",
    ".worldSaveData.InvaderDeclarationSaveData.ValidatedStartPointIds.Value": "Guid",
    ...
    ".SaveData.WorldMapUISaveDataMap.Value": "StructProperty",
