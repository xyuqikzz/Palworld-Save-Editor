...
MIGRATION_ERROR_CODES = frozenset(
    {
        ...
        "MIGRATION_PLAYER_MAPPING_REQUIRED",
        "MIGRATION_PLAYER_MAPPING_AMBIGUOUS",
        "MIGRATION_PLAYER_MAPPING_DUPLICATE",
        "MIGRATION_PLAYER_TARGET_MISSING",
        "MIGRATION_DPS_UNSUPPORTED",
        "MIGRATION_REFERENCE_UNSUPPORTED",
        "MIGRATION_ID_COLLISION_UNRESOLVED",
        ...
        "MIGRATION_WGS_TARGET_UNSUPPORTED",
    }
)
